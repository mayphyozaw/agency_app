                                        ...
                                        <tr style="text-align: center">
                                            ...
                                            <td>
                                                <a href="{{ route('labors.edit', $labor->id) }}"
                                                    class="btn btn-sm btn-warning border-0">Edit</a>
                                            </td>
                                            <td>
                                                <a href="{{ route('rejectPassport', $labor->id) }}"
                                                    class="btn btn-sm btn-danger border-0">Reject</a>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                @if (!empty($labor->photo))
                                                    <img src="{{ Storage::url($labor->photo) }}" width="50"
