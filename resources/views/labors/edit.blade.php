    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('labors.update', $labor->id) }}" class="form-horizontal form-bordered"
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" type="text" name="phone" value="{{ $labor->phone }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" type="text" name="address" value="{{ $labor->address }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" type="text" name="nrc" value="{{ $labor->nrc }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" placeholder="dd/mm/yyyy" type="date" name="date_of_birth"
                                        value="{{ $labor->date_of_birth }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" placeholder="Passport Number" type="text"
                                        name="passport_number" value="{{ $labor->passport_number }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" placeholder="Passport Issue Date" type="date"
                                        name="passport_issue_date" value="{{ $labor->passport_issue_date }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" placeholder="Passport Expire Date" type="date"
                                        name="passport_expired_date" value="{{ $labor->passport_expired_date }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" placeholder="Place of Passport" type="text"
                                        name="passport_place" value="{{ $labor->passport_place }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" placeholder="OWIC Card Number" type="text"
                                        name="owic_card_number" value="{{ $labor->owic_card_number }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" placeholder="OWIC Card Issue Date" type="date"
                                        name="owic_card_issue_date" value="{{ $labor->owic_card_issue_date }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" placeholder="OWIC Card Expire Date" type="date"
                                        name="owic_card_submit_date" value="{{ $labor->owic_card_submit_date }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" placeholder="Nation/Religion" type="text"
                                        name="nation_religion" value="{{ $labor->nation_religion }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" placeholder="prominent_sign" type="text"
                                        name="prominent_sign" value="{{ $labor->prominent_sign }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" placeholder="Working Experience" type="text"
                                        name="working_experience" value="{{ $labor->working_experience }}">
                                </div>
                            </div>
...
@section('script')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\UpdateLabor', '#create-form') !!}
@endsection
